		...
		try {
			...
			if (upgradeData.customToken) {
				try {
					...
					setError(
						'Account upgraded successfully. Please log in with your email and password.'
					)
					setLoading(false)
				...
				<div className='w-full max-w-md'>
					...
					<FormContainer>
						<div className='alert alert-success'>
							<span>
								Your account has been upgraded successfully. You now have full
								member access with persistent sessions and profile management.
							</span>
						</div>
			...
			<div className='w-full max-w-md'>
				<div className='mb-6 text-center'>
					...
					<p className='text-sm opacity-70'>
						Add a password to your account to enable persistent sessions, login,
