...
describe('SignUpPage1', () => {
  ...
  it('displays error for email already in use', async () => {
    ...
    mockSignInWithEmailAndPassword.mockRejectedValueOnce(new Error('auth/email-already-in-use'));
  ...
  it('displays error for weak password', async () => {
    ...
    mockSignInWithEmailAndPassword.mockRejectedValueOnce(new Error('auth/weak-password'));
