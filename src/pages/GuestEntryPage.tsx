      ...
      <PageContainer>
        <div className="w-full max-w-md">
          <div className="text-center mb-6">
            ...
            <h1 className="text-4xl font-bold text-base-content mb-2">Event Code Valid</h1>
          ...
          <FormContainer>
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <PrimaryButton onClick={handleLogin} className="w-full" type="button">
                  Login to Register
                </PrimaryButton>
    ...
    <PageContainer>
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-4xl font-bold text-base-content mb-2">Event Code Entry</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="form-control">
              <label htmlFor="eventCode" className="label">
                <span className="label-text text-base-content font-medium">Event Code</span>
              </label>
              <input
                id="eventCode"
                type="text"
            ...
            <PrimaryButton type="submit" disabled={loading || !eventCode} className="w-full">
